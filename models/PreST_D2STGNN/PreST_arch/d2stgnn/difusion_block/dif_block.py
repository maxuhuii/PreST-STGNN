...
class DifBlock(nn.Module):
    ...
    def forward(self, X, X_spa, dynamic_graph, static_graph,learn_graph):
        Z = self.localized_st_conv(X_spa, dynamic_graph, static_graph,learn_graph)
        # forecast branch
        forecast_hidden = self.forecast_branch(
            X_spa, Z, self.localized_st_conv, dynamic_graph, static_graph,learn_graph)
        # backcast branch
